...
#build_macosx64 {
#    QMAKE_TARGET_BUNDLE_PREFIX = co.briacoin
#    BOOST_LIB_SUFFIX=-mt
#    BOOST_INCLUDE_PATH=/usr/local/Cellar/boost/1.62.0/include
#    BOOST_LIB_PATH=/usr/local/Cellar/boost/1.62.0/lib
...
QMAKE_CXXFLAGS_WARN_ON = -fdiagnostics-show-option -Wall -Wextra -Wno-ignored-qualifiers -Wformat -Wformat-security -Wno-unused-parameter -Wstack-protector -Wno-unused-variable
...
# also add new translations to bria.qrc under translations/
...
macx:ICON = src/qt/res/icons/bria.icns
macx:TARGET = "BriaCoin"
