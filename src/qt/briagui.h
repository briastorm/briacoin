...
/**
  Bria GUI main class. This class represents the main window of the Bria UI. It communicates with both the client and
  wallet models to give the user an up-to-date view of the current core state.
*/
class BriaGUI : public QMainWindow
{
    Q_OBJECT
public:
    explicit BriaGUI(QWidget *parent = 0);
    ~BriaGUI();
