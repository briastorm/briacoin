...
void OptionsModel::Init()
{
    ...
    nDisplayUnit = settings.value("nDisplayUnit", BitcoinUnits::BRIA).toInt();
    ...
    fAutoRedeemBria = settings.value("fAutoRedeemBria", false).toBool();
...
QString OptionsModel::optionIDName(int row)
{
    ...
    case AutoRedeemBria: return "AutoRedeemBria";
...
bool OptionsModel::setData(const QModelIndex & index, const QVariant & value, int role)
{
    ...
    if(role == Qt::EditRole)
    {
        ...
        case DisplayAddresses:
            ...
            emit displayUnitChanged(settings.value("nDisplayUnit", BitcoinUnits::BRIA).toInt());
            break;
        case DetachDatabases: {
        ...
        case AutoRingSize: {
            ...
            break;
        case AutoRedeemBria: {
            fAutoRedeemBria = value.toBool();
            settings.setValue("fAutoRedeemBria", fAutoRedeemBria);
            }
            break;
        case MinRingSize: {
...
bool OptionsModel::getAutoRedeemBria() { return fAutoRedeemBria; }
