...
// test_bria --log_level=all  --run_test=smsg_tests
...
BOOST_AUTO_TEST_CASE(smsg_test)
{
    ...
    const std::string sTestMessage =
        "Bria is a STATE OF THE ART, Proof of Stake crypto currency, utilizing cutting edge technology, "
        "such as instant p2p encrypted messaging (BriaChat), and anonymous dual-key stealth addresses (BriaSend). "
